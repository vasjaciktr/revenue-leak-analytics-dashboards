-- Leakonic Core v1 premium-setup.sql

-- IMPORTANT: Replace YOUR_PROJECT with your project name
-- IMPORTANT: Replace YOUR_GA4_DATASET with your Google Analytics 4 dataset name
-- IMPORTANT: Replace YOUR_GOOGLE_ADS_DATASET with your Google Ads dataset name
